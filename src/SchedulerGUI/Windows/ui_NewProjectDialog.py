...
class Ui_NewProjectDialog(object):
    def setupUi(self, NewProjectDialog):
        ...
        NewProjectDialog.resize(389, 201)
        NewProjectDialog.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.verticalLayoutWidget = QtGui.QWidget(NewProjectDialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 371, 183))
        ...
        self.lineEditSystem = QtGui.QLineEdit(self.verticalLayoutWidget)
        ...
        self.OpenSystem = QtGui.QPushButton(self.verticalLayoutWidget)
        ...
        self.lineEditConfig = QtGui.QLineEdit(self.verticalLayoutWidget)
        ...
        self.OpenConfig = QtGui.QPushButton(self.verticalLayoutWidget)
        ...
        self.ProjectName = QtGui.QLineEdit(self.verticalLayoutWidget)
